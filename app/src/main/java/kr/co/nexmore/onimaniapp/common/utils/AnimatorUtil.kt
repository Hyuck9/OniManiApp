...
object AnimatorUtil {
    ...
    fun startLoadingAnimation(loadingImageImageView: ImageView) {
        // Alpha
        loadingImageImageView.alpha = 0f
        ...
        saturation.addUpdateListener { loadingImageImageView.colorFilter = ColorMatrixColorFilter(cm) }
