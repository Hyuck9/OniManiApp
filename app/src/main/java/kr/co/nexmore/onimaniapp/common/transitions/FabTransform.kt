package kr.co.nexmore.onimaniapp.common.transitions
...
import kr.co.nexmore.onimaniapp.common.utils.AnimatorUtil
...
class FabTransform(@param:ColorInt private val color: Int, @param:DrawableRes private val icon: Int) : Transition() {
    ...
    override fun createAnimator(sceneRoot: ViewGroup,
        ...
        return AnimatorUtil.NoPauseAnimator(transition)
    }
    ...
    companion object {
        ...
        private val PROP_BOUNDS = "onimani:fabTransform:bounds"
